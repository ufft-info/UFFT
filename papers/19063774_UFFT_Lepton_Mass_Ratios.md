# UFFT Paper #10 — Lepton Mass Ratios from the Face Laplacian Spectrum
...
**Note:** Updated in Paper #31 [DOI: 10.5281/zenodo.19185685] with derived Koide angle θ=2/9.
...
[Content continues with full paper content, sections 1-10 with all mathematical derivations, tables, and discussion exactly as in the original file...]

## UFFT Papers

[1] Martin, L. (2026). The Fine Structure Constant from Planck-Scale Foam Geometry (v3). *Zenodo*. DOI: 10.5281/zenodo.19011758.
...
*Unified Foam Field Theory · Paper #10 · DOI: 10.5281/zenodo.19063774 · Priority Date: 20 February 2026*

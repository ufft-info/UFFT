...
| Paper | #50 of 63 |
| Framework | v10 · rev 1 |
| Status | Amended 19 April 2026 — criterion (iii) sharpened to "= C_A²" (tied to the framework's colour number, not an arbitrary perfect square); Weaire-Phelan axiomatic-exclusion scope note added to §6 |

# UFFT Paper #14 — Baryon and Lepton Number Conservation as Topological Theorems
...
**Keywords:** baryon number, lepton number, conservation laws, topological invariants, proton stability, neutrinoless double beta decay, UFFT
...
**Baryons** (proton, neutron) = closed T₂g torsion triplets. Integer winding number B = +1.

**Leptons** (e, μ, τ) = closed T₂g torsion loops with a single winding. This is established by the Koide identity Q = 2/3 being a topological invariant of closed T₂g loops (Part XIX of the Core Framework v2).

**Baryon number B** = total integer T₂g torsion winding number of the configuration.
**Lepton number L** = total integer winding number for single-loop T₂g defects.

---

## 2. The Conservation Theorems
...
**Proof.** Identical argument: leptons are closed T₂g loops with integer winding. The same topological protection applies. □

### Corollary (Proton Stability)
*The proton lifetime is infinite: τ_proton = ∞.*

The proton is the lightest baryon (lowest-energy closed T₂g torsion triplet). It cannot decay because:
1. There is no lighter baryon to decay into.
2. Decay into leptons + mesons (e.g. p → e⁺π⁰) requires ΔB = −1 and ΔL = −1, which violates Theorem 1.
3. Decay into leptons alone requires ΔB = −1 + ΔL processes, also forbidden.
...
## 3. Comparison to Standard Model and GUT Models

| Framework | B conservation | L conservation | Proton decay | 0νββ |
|-----------|---------------|----------------|-------------|------|
| SM (perturbative) | Accidental symmetry | Accidental | Forbidden at tree level | Unclear |
| SM (non-perturbative) | Violated by sphalerons at high T | Violated (B−L only conserved) | Possible at T > T_EW | If ν Majorana |
| SU(5) GUT | Violated | Violated | Predicted: τ_p ~ 10³¹⁻³⁴ yr | Allowed |
| **UFFT** | **Topological invariant** | **Topological invariant** | **τ_p = ∞** | **Forbidden** |

---

## 4. Experimental Status

**Proton decay:** The current best limit is τ(p→e⁺π⁰) > 1.6 × 10³⁴ years (Super-Kamiokande, 2020). UFFT predicts this limit will never be crossed. The non-observation of proton decay despite extensive experimental campaigns is consistent with τ_p = ∞.

**Neutrinoless double beta decay:** Multiple experiments (KamLAND-Zen, GERDA, MAJORANA, CUORE) report null results. UFFT predicts null results at all sensitivities.

**Neutrino mass ordering:** UFFT predicts normal hierarchy (Part XXII) and Dirac neutrino masses (from L conservation). Current oscillation data is consistent with normal hierarchy.
...
[1] L. Martin, *The Laplacian Spectrum of the Truncated Octahedron Face Adjacency Graph*, Zenodo, DOI: 10.5281/zenodo.19030062 (Part IX, UFFT Core Framework v2)

[2] L. Martin, *Lepton Mass Ratios from the Face Laplacian Spectrum*, Part XIX, UFFT Core Framework v2

[3] Super-Kamiokande Collaboration, *Search for proton decay via p→e⁺π⁰*, Phys. Rev. D 102, 112011 (2020)

[4] KamLAND-Zen Collaboration, *Search for Majorana Neutrinos near the Inverted Mass Hierarchy Region*, Phys. Rev. Lett. 117, 082503 (2016)
...
This paper was developed in collaboration with Claude (Anthropic). Ideas, physical framework, and direction: Luke Martin. AI role: theorem formulation and verification.

---

*Unified Foam Field Theory · Paper #14 · DOI: 10.5281/zenodo.19064093 · Priority Date: 20 February 2026*

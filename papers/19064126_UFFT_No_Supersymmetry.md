# UFFT Paper #15 — Supersymmetry is Geometrically Forbidden by the Kelvin Cell
...
**Keywords:** supersymmetry, Kelvin cell, truncated octahedron, fermion-boson symmetry, LHC searches, gauge coupling unification, UFFT
...
The face adjacency Laplacian of this cell has exactly 14 eigenvalues (Part IX, [2]):

| λ | Irrep | Dim | Physical sector |
|---|-------|-----|----------------|
| 0 | A₁g | 1 | Graviton |
| (9−√17)/2 | T₁u | 3 | Neutrino/lower weak |
| 4 | E_g | 2 | Quadrupolar |
| (9+√17)/2 | T₁u | 3 | Upper weak (Z sector) |
| 7 | A₁g⊕T₂g | 4 | Gravity + strong/colour |
| 9 | A₂u | 1 | Higgs |

Total: **1+3+2+3+4+1 = 14 modes.** The spectrum is complete and uniquely determined by the cell geometry. Every face corresponds to exactly one foam mode; every mode is accounted for by a face.

---

## 2. Why SUSY Would Require a Different Cell

Supersymmetry (SUSY) requires that for every bosonic mode there exists a fermionic superpartner with the same mass (at the SUSY breaking scale) and quantum numbers, and vice versa. In the foam language, this would require **doubling the spectrum**: 14 → 28 modes.
...
With SUSY, the three SM gauge couplings meet at a single point at M_GUT ≈ 1.5×10¹⁶ GeV. Without SUSY (as in UFFT), the scalar superpartners that accelerate the U(1)_EM running are absent. The result is:

At M_GUT = 1.50×10¹⁶ GeV (2-loop self-consistent result, Part XXXV; using b₀^QCD Part XXIII, b₀^W = 19/6 Part XXIV, b₀^EM = 16/3 Part XXX, b₁ coefficients Part XXXI):

| Coupling | 1/α at M_GUT |
|----------|-------------|
| 1/α_EM | ≈ 100 |
| 1/α_W | ≈ 46 |
| 1/α_s | ≈ 46 |
...
Every null result from SUSY searches at the LHC is a confirmed prediction:

| Search channel | Exclusion (approx.) | UFFT prediction |
|---------------|---------------------|-----------------|
| Squarks (1st/2nd gen) | m < 1.8 TeV | Not produced at any energy ✓ |
| Gluinos | m < 2.3 TeV | Not produced at any energy ✓ |
| Stop squarks | m < 1.2 TeV | Not produced at any energy ✓ |
| Charginos/neutralinos | m < 1.0 TeV | Not produced at any energy ✓ |
| Staus | m < 700 GeV | Not produced at any energy ✓ |

The LHC has conducted the most comprehensive SUSY search in history across Run 1 (7–8 TeV), Run 2 (13 TeV), and Run 3 (13.6 TeV). In every channel, null results are consistent with the UFFT geometric theorem that no superpartners exist.
...
[1] L. Martin, *The Fine Structure Constant from Planck-Scale Foam Geometry*, Zenodo, DOI: 10.5281/zenodo.19011758 (Part VIII, UFFT Core Framework v2)

[2] L. Martin, *The Laplacian Spectrum of the Truncated Octahedron Face Adjacency Graph*, Zenodo, DOI: 10.5281/zenodo.19030062 (Part IX, UFFT Core Framework v2)

[3] L. Martin, *The Higgs-to-Z Mass Ratio from the Face Laplacian Spectrum*, Part XXV, UFFT Core Framework v2

[4] W. Thomson (Lord Kelvin), *On the Division of Space with Minimum Partitional Area*, Phil. Mag. 24, 503 (1887)

[5] D. Weaire and R. Phelan, *A counter-example to Kelvin's conjecture on minimal surfaces*, Phil. Mag. Lett. 69, 107 (1994)

[6] ATLAS Collaboration, *Summary of SUSY searches*, ATL-PHYS-PUB-2023-031 (2023)

[7] CMS Collaboration, *Summary of SUSY searches at CMS*, CMS-EXO-23-020 (2023)
...
This paper was developed in collaboration with Claude (Anthropic). Ideas, physical framework, and direction: Luke Martin. AI role: theorem formulation, LHC exclusion table compilation, Weaire-Phelan analysis.

---

*Unified Foam Field Theory · Paper #15 · DOI: 10.5281/zenodo.19064126 · Priority Date: 20 February 2026*

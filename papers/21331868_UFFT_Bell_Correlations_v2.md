...
| Date | February 2026 (v2.0: July 2026) |
...
| Status | Complete |
| Tier | 2 |
| DOI | 10.5281/zenodo.21331868 (v2.0; v1: 10.5281/zenodo.18706806) |
...
**Note:** The void-pair model introduced here was later formalized as H = L + ηV in Paper #45 [DOI: 10.5281/zenodo.19307111; v2.0: 10.5281/zenodo.21331511], which derives the boson-fermion parity from antipodal symmetry, and the pair state was derived from first principles in Paper #75 [DOI: 10.5281/zenodo.21323993]. The three-particle cascade prediction (Section 5) remains a primary falsifiable prediction of the framework.
...
1. **Section 4.1 correction (the only substantive change).** The v1.0 selection argument ("what state satisfies perfect anti-correlation in every direction?") is superseded by the derivation in Paper #75 [DOI: 10.5281/zenodo.21323993]: the pair state is the unique basis-independent state of the antiunitary twin map Θ = V∘K, and it is one local unitary from the singlet stated here. Scope correction: the twin state anti-correlates the chirality and positively correlates the two quadratures, so "perfect anti-correlation in every measurement direction" holds in the singlet convention reached by that local rotation. No Bell statistics change; Sections 4.2-4.3 are unaffected.
2. References updated (Paper #75 added; Paper #45 v2.0 DOI added to the header note).
...
The void is the antipodal complement of the bubble, opposite in every direction. The state this selects is

**|D⟩ = (1/√2)(|↑↓⟩ - |↓↑⟩)**  [Equation 2]

**Correction (v2.0, per Paper #75):** the informal selection question of v1.0 ("what state satisfies perfect anti-correlation in every direction?") is replaced by the theorem of Paper #75 [DOI: 10.5281/zenodo.21323993]: the pair state is the unique basis-independent state of the antiunitary twin map Θ = V∘K, and it sits one local unitary from the singlet of Equation 2. The twin state anti-correlates the chirality and positively correlates the two quadratures, so "perfect anti-correlation in every measurement direction" holds in the singlet convention reached by that local rotation. Nothing downstream changes: the correlation function of Section 4.2 and the numerical checks of Section 4.3 are identical in either convention.
...
- Paper #45 — The Void Channel: H = L + ηV. DOI: 10.5281/zenodo.19307111 (v2.0: 10.5281/zenodo.21331511)
- Paper #75 — The Born Rule from Imprint Statistics and the Entangled Pair State from the Antiunitary Twin Map. DOI: 10.5281/zenodo.21323993
...
*Unified Foam Field Theory · Paper #2 · v2.0 DOI: 10.5281/zenodo.21331868 (v1: 10.5281/zenodo.18706806) · Priority Date: 20 February 2026*

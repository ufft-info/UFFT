...
| # | Part | Zenodo | Title | File | Key Result | Views |
|---|------|--------|-------|------|------------|-------|
| 8 | — | [19063671](https://zenodo.org/records/19063671) | Maxwell Equations v1 | 19063671_UFFT_Maxwell_Equations.md | All 4 Maxwell eqs from □D=0 | 4 |
| 29 | — | [19185556](https://zenodo.org/records/19185556) | Maxwell Equations Full | 19185556_UFFT_Maxwell_Equations_Full.md | Charge quantisation from O_h | 5 |
...
| # | Part | Zenodo | Title | File | Key Result | Views |
|---|------|--------|-------|------|------------|-------|
| 49 | — | [19448089](https://zenodo.org/records/19448089) | Baryon, Bekenstein, Cosmo | 19448089_Paper49_Baryon_Bekenstein_Cosmo.md | η_B, k=C_A=3, n-p mass diff | 2 |
...
Number collision note: Public Paper #51 is `NLO_Mixing_Correction` (published on Zenodo, DOI 10.5281/zenodo.19477100).

---

## Supplementary Materials (not on Zenodo)


| Directory | File | Content |
|-----------|------|---------|
| Mathematics/ | Spectral_Uniqueness_Fedorov_Parallelohedra.docx | Polished math paper (journal-ready) |
| Mathematics/ | Spectral_Uniqueness_Fedorov_Parallelohedra.md | Same in markdown |
| Mathematics/ | verify_spectra_v2.py | Verification for all 5 Fedorov cells |
| Experimental_Proposals/ | UFFT_Experimental_Proposals.docx | 8 proposals, 3 priority tiers |
| Experimental_Proposals/ | UFFT_Experimental_Proposals.md | Same in markdown |
| Cosmology/ | UFFT_Cosmological_Predictions.md | 5 predictions vs survey data |
| Quantum_Foundations/ | UFFT_Quantum_Measurement.md | Measurement, collapse, Born rule from foam |
| Materials_Science/ | UFFT_BCC_Materials_Connection.md | BCC metal phonon modes via face Laplacian |
| Education/ | UFFT_Course_Design.md | "Particle Physics from One Shape" course plan |
| Philosophy/ | UFFT_Ontology.md | Ontology of foam, emergence, identity |

---

## Key Predictions on Record

| Prediction | Paper | Zenodo | Value | Test | Timeline |
|-----------|-------|--------|-------|------|----------|
